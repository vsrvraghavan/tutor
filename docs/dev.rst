...
- The edx-platform `development requirements <https://github.com/edx/edx-platform/blob/open-release/koa.test01/requirements/edx/development.in>`__ are installed.
